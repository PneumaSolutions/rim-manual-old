...
<!-- end -->
That's all there is to it! Once RIM is installed, it will automatically launch. In addition, a desktop shortcut will be automatically created, along with a multipurpose global hotkey (*Windows+Shift+Backspace*) which, among other things, automatically launches RIM from wherever you are.
